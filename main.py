...
def main():
    while True:
        cleanUp()
        print_banner()
        user_input_opration = input(
            fr.LIGHTYELLOW_EX+"[*] wich opration you wanna used : "+fr.LIGHTCYAN_EX)
        if user_input_opration in str(list(range(1, 6))+[99]):
            ...
            input(
                fr.LIGHTRED_EX+"[!] please enter a right number, press enter to run again..."+fr.LIGHTWHITE_EX)
